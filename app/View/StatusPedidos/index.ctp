<div class="statusPedidos index">
	<h2><?php echo __('Status Pedidos'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $statusPedido['StatusPedido']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $statusPedido['StatusPedido']['id'])); ?>
